...
public class SnakeAndLadderService {
	...
	// Keeping players in game service as they are specific
	//to this game and not the board. Keeping pieces in the board instead.
    ...
    private static final int DEFAULT_BOARD_SIZE = 100; //The board have 100 cells numbered from 1 to 100.
    ...
    private boolean isGameCompleted() {
        ...
        return currentNumberOfPlayers < initialnoofplayers;
    }
